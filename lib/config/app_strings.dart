class AppStrings {
  static const appTitle = '作文助手';

  // 提示文本
  static const inputHint = '请输入内容或点击右上角图标识别图片文字...';
  static const emptyContentError = '请输入内容';
  static const errorPrefix = '错误: ';

  // 按钮和工具提示
  static const submitButton = '提交';
  static const cancelButton = '取消';
  static const confirmButton = '确定';
  static const imageRecognitionTooltip = '从图片识别文字';
  static const editTextTooltip = '编辑文本';

  // 对话框标题
  static const editDialogTitle = '编辑内容';
